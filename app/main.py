...
class ConstructionProductivityVisualizer(): 
	...
	def side_bar_information(self): 
		self.choice = st.sidebar.selectbox('Learn more about the methodology used for this', 
			('Research', 'Assumptions', 'Data'))
		if self.choice == 'Research': 
			st.sidebar.markdown( f'The majority of finding used for this analysis was based of the Natioanl Research Council of Canada \
