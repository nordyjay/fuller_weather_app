...
class OttawaWeatherAnalytics:
    ...
    def make_monthly_productivity_plot(self):
        ...
        self.monthly_productivity_plot = fig.show(auto_open=False)
    ...
    def plot_productivity_by_month(self, i=1):
        ...
        fig.add_trace(
            go.Scatter(
                x=monthly_frames[self.tdi[i][0]].index,
                y=monthly_frames[self.tdi[i][0]].iloc[:, 1],
                fill="tonexty",
                line_color="hotpink",
            )
        )
